...
class GUMP
{
    ...
    {
        // get_magic_quotes_gpc() was removed in PHP 8.0 (the feature itself was removed
        // in PHP 5.4). It always returned false in practice on any supported PHP version,
        // so we hard-code that instead of calling the now-undefined function.
        $magic_quotes = false;
        ...
        foreach ($fields as $field) {
            if (!isset($input[$field])) {
                ...
                if (is_string($value)) {
                    ...
                    $value = safe_sanitize_string($value);
                }
    ...
    {
        return safe_sanitize_string($value);
    }
