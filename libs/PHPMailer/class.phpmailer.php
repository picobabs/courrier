...
class PHPMailer
{
    ...
    protected function encodeFile($path, $encoding = 'base64')
    {
        try {
            ...
            // get_magic_quotes_runtime()/set_magic_quotes_runtime() were removed in PHP 7.0+
            // and calling them is a fatal "undefined function" error on modern PHP.
            // The "magic quotes" feature they controlled no longer exists, so this
