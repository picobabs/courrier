...
$('#ctrl-iduser').on('input', function(){ 
	let id = $(this).val();
    lireNiveau(id);
});
function lireNiveau(leid){
    ...
    var request = $.ajax({
        ...
        url: siteAddr+'api/niveauUser/?csrf_token='+csrfToken, //our api link/url
    ...
    request.done(function (response, textStatus, jqXHR){
        $('#ctrl-niveau').val(response.data.niveau_imputation);
    });
