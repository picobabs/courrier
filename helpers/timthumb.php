...
class timthumb {
	...
	protected function param($property, $default = ''){
		// ATTENTION : timthumb.php est appele DIRECTEMENT par le navigateur
		// (<img src="helpers/timthumb.php?src=...">) et n'inclut ni config.php
		// ni helpers/Functions.php. Il ne faut donc appeler ici AUCUNE fonction
		// de l'application : cela provoquerait une erreur fatale
		// "Call to undefined function" et casserait toutes les images du site.
		// L'assainissement est fait sur place, sans dependance externe.
