	...
	public static function ajaxpage_spinner()
	{
		...
		<div class="ajax-page-load-indicator" style="display:none">
			<div class="text-center d-flex justify-content-center load-indicator">
				...
				<span class="font-weight-bold"><?php print_lang('chargement_'); ?></span>
			</div>
		</div>
		<?php
	}
			...
			<div class="modal-dialog modal-dialog-centered modal-sm">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title"><?php print_lang('importer_des_donn_es'); ?></h4>
						<button type="button" class="close" data-dismiss="modal">&times;</button>
					</div>
					<div class="modal-body">
						<label><?php print_lang('s_lectionnez_le_fichier_importer'); ?> <input required="required" class="form-control form-control-sm" type="file" name="file" /> </label>
						<small class="text-muted"><?php print_lang('types_de_fichiers_pris_en_charge'); ?>(csv , json)</small>

					</div>
					<div class="modal-footer">
						<button type="reset" class="btn btn-secondary" data-dismiss="modal"><?php print_lang('fermer'); ?></button>
						<button type="submit" class="btn btn-primary"><?php print_lang('importer_des_donn_es'); ?></button>
					</div>
				</div>
			</div>
		</form>
