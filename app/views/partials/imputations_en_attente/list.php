...
$can_add = ACL::is_allowed("imputations_en_attente/add");
$can_edit = ACL::is_allowed("imputations_en_attente/edit");
$can_view = ACL::is_allowed("imputations_en_attente/view");
$can_delete = ACL::is_allowed("imputations_en_attente/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h5 class="record-title"><?php print_lang('imputations_en_attente'); ?></h5>
                </div>
                <div class="col-sm-4 ">
                </div>
                        ...
                        <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                            <ul class="breadcrumb m-0 p-1">
                                ...
                                <li class="breadcrumb-item">
                                    <a class="text-decoration-none" href="<?php print_link('imputations_en_attente'); ?>">
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class=" animated fadeIn page-content">
                        <div id="imputations_en_attente-list-records">
                                ...
                                <table class="table  table-striped table-sm text-left">
                                    <thead class="table-header bg-light">
                                        <tr>
                                            ...
                                            <th  class="td-courrier_intitule"> <?php print_lang('intitule_courrier'); ?></th>
