...
<div class="container">
	...
	<div class="card card-body my-3">
		...
		<div>Tel:  <a href="tel:<?php echo SUPPORT_PHONE; ?>" class="bold"><?php echo SUPPORT_PHONE; ?></a></div>
		<div>Email: <a href="mailto:<?php echo SUPPORT_EMAIL; ?>" class="bold"><?php echo SUPPORT_EMAIL; ?></a></div>
	</div>
