            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("droit_select/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="roles"><?php print_lang('profil'); ?> <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-roles" name="roles"  placeholder="<?php print_lang('s_lectionnez_une_valeur'); ?>"    class="custom-select" >
                                                    ...
                                                    <?php
                                                    $rec = $data['roles'];
                                                    $roles_options = $comp_model -> droit_select_roles_option_list();
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-etat_courrier" name="etat_courrier"  placeholder="<?php print_lang('s_lectionnez_une_valeur'); ?>"    class="custom-select" >
                                                    <option value=""><?php print_lang('s_lectionnez_une_valeur'); ?></option>
                                                    <?php
                                                    $rec = $data['etat_courrier'];
                                                    $etat_courrier_options = $comp_model -> droit_select_etat_courrier_option_list();
