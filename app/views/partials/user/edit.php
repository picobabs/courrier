...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><?php print_lang('fiche_user'); ?></h4>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-login"  value="<?php  echo $data['login'] ?? '' ; ?>" type="text" placeholder="<?php print_lang('entrer_login'); ?>"  required="" name="login"  data-url="api/json/user_login_value_exist/" data-loading-msg="<?php print_lang('v_rifier_les_disponibilit_s_'); ?>" data-available-msg="<?php print_lang('disponible'); ?>" data-unavailable-msg="<?php print_lang('indisponible'); ?>" class="form-control  ctrl-check-duplicate" />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select id="ctrl-division" data-load-path="<?php print_link('api/json/user_division_option_list') ?>" name="division" placeholder="<?php print_lang('s_lectionnez_une_valeur'); ?>" class="custom-select">
                                                            <option value=""><?php print_lang('s_lectionnez_une_valeur'); ?></option>
                                                            <?php
                                                            // Les divisions de la direction actuelle sont pre-chargees cote serveur ;
                                                            // changer la direction les recharge ensuite via l'API.
                                                            $rec = $data['division'] ?? '';
                                                            $division_options = !empty($data['direction']) ? $comp_model -> user_division_option_list($data['direction']) : array();
