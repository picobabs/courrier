...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><?php print_lang('courrier'); ?></h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="courrier-courriersaimputer-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-date_courrier"> <?php print_lang('date_courrier'); ?></th>
                                                <th  class="td-date_reception"> <?php print_lang('date_reception'); ?></th>
                                                <th  class="td-intitule"> <?php print_lang('intitule'); ?></th>
                                                <th  class="td-objet"> <?php print_lang('objet'); ?></th>
                                                <th  class="td-fichier"> <?php print_lang('fichier'); ?></th>
                                                <th  class="td-etat_etat"> <?php print_lang('etat_etat'); ?></th>
                                                <th  class="td-Imputer"> <?php print_lang('imputer'); ?></th>
                                                <th  class="td-date_saisie"> <?php print_lang('date_saisie'); ?></th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-numero_courrier"> <?php echo $data['numero_courrier'] ?? '' ; ?></td>
                                                ...
                                                <td class="td-Imputer"><a href="<?php print_link("imputation/list?idcourrier=" . urlencode($data['idcourrier'] ?? '')) ?>"><?php echo $data['Imputer'] ?? '' ; ?></a></td>
                                                <td class="td-date_saisie"> <?php echo $data['date_saisie'] ?? '' ; ?></td>
                                                <th class="td-btn">
                                                    <?php
