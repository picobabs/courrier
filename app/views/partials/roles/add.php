                        ...
                        <form id="roles-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("roles/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="role_name"><?php print_lang('profil'); ?> <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-role_name"  value="<?php  echo $this->set_field_value('role_name',""); ?>" type="text" placeholder="<?php print_lang('entrer_profil'); ?>"  required="" name="role_name"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
